...
public final class Fixtures {
    ...
    public static final String DUMMY_TM_IFO_FILE = DUMMY_TM_DICT_FOLDER + "/stardict.ifo";

    public static final String DUMMY_TM_IDX_FILE = DUMMY_TM_DICT_FOLDER + "/stardict.idx";

    public static final String DUMMY_TM_DICT_DZ_FILE = DUMMY_TM_DICT_FOLDER + "/stardict.dict.dz";

    public static final String DUMMY_MULTI_DICT_FOLDER = "dymmy-dict-multi-type";

    public static final String DUMMY_MULTI_IFO_FILE = DUMMY_MULTI_DICT_FOLDER + "/stardict.ifo";

    public static final String DUMMY_MULTI_IDX_FILE = DUMMY_MULTI_DICT_FOLDER + "/stardict.idx";

    public static final String DUMMY_MULTI_DICT_DZ_FILE = DUMMY_MULTI_DICT_FOLDER + "/stardict.dict.dz";

    public static final String DUMMY_MULTI_RES_ZIP_FILE = DUMMY_MULTI_DICT_FOLDER + "/res.zip";
